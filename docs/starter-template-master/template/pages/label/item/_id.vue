    ...
    <div class="fl left-list">
      <div class="tab-content">
        <div id="index" class="tab-pane active">
          <div class="tag-intro">
            <h3 class="title">
              <img src="~/assets/img/widget-h5.png" alt /> HTML5
              <a href="JavaScript:;" class="sui-btn btn-default guanzhu">关注</a>
            </h3>
            <p class="words">
              HTML5 是 HTML 下一个的主要修订版本，现在仍处于发展阶段。广义论及 HTML5 时，实际指的是包括 HTML、CSS 和 JavaScript
              在内的一套技术组合。
              <a
                href="javascript:;"
                id="goto"
            ...
            <ul class="sui-nav nav-tabs" id="tab-line">
              ...
              <li>
                <a href="#article" data-toggle="tab">
                  <i class="fa fa-file-text" aria-hidden="true"></i>文章
                </a>
              </li>
              <li>
                <a href="#job" data-toggle="tab">
                  <i class="fa fa-black-tie" aria-hidden="true"></i>职位
                </a>
              </li>
              <li>
                <a href="#baike" data-toggle="tab">
                ...
                <div id="qa" class="tab-pane active">
                  <div class="show-type">
                    ...
                    <div class="sui-btn-group">
                      <button class="sui-btn active">时间</button>
                      <button class="sui-btn">得票数</button>
                    </div>
                  </div>
                    ...
                    <li class="qa-item">
                      ...
                      <div class="fl info">
                        <div class="question">
                          ...
                          <p class="title">springMVC的controller接收json数据失败</p>
                          <ul class="sui-tag">
                            <li>Php</li>
                            <li>Javascript</li>
                          </ul>
                    ...
                    <li class="qa-item">
                      ...
                      <div class="fl info">
                        <div class="question">
                          ...
                          <p class="title">监听器中timer查询数据库</p>
                          <ul class="sui-tag">
                            <li>Php</li>
                            <li>Javascript</li>
                          </ul>
                    ...
                    <li class="qa-item">
                      ...
                      <div class="fl info">
                        <div class="question">
                          ...
                          <p class="title">服务器上安装了一个考试系统ASP.NET,安装完成后访问不了，求助</p>
                          <ul class="sui-tag">
                            <li>Php</li>
                            <li>Javascript</li>
                          </ul>
                  ...
                  <div class="article">
                    <ul class="detail-list">
                      <li class="article-item">
                        ...
                        <div class="article">
                          <p class="title">分享一个非常全的正则验证车牌格式的函数</p>
                          <p class="desc">
                            PHP CURL POST 最近公司运营平台因为要接通另外一个服务端的接口，要求模拟HTTP POST
                            提交数据。很久没有写过CURL了，特意上官网查了下文档以及复习下HTTP POST参数所代表的...
                          </p>
                          <p class="author">
                            <span class="photo">
                              <img src="~/assets/img/widget-photo.jpg" alt />
                            </span>
                            <span class="name">luckness</span>发表于
                            <span>1</span>分钟前
                          </p>
                        </div>
                      ...
                      <li class="article-item">
                        ...
                        <div class="article">
                          <p class="title">css 这个当文本写不开的时候用省略号,是怎么弄得呢?</p>
                          <p class="desc">
                            PHP CURL POST 最近公司运营平台因为要接通另外一个服务端的接口，要求模拟HTTP POST
                            提交数据。很久没有写过CURL了，特意上官网查了下文档以及复习下HTTP POST参数所代表的...
                          </p>
